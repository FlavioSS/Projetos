...
public class Conta {
    ...
    // atributos
    // Ajustar o modificador de acesso aos membros da classe. Usar protected para q as classes filhas de conta possam
    // acessa-las exceto outras como a main. Ou seja, quem recebe extends no método.
...
//exemplo de overloading
    public void sacar(double valor) {
        ...
        // apenas com essa condição no método sacar ele não vai conseguir sacar um valor maior do que o seu saldo e vai
        // continuar com o mesmo valor no retorno
...
//			/*}*/  /*{*/
        ...
        // this.saldo -= 1; //descontando 1 real a cada operação de saque //essa regra não se coloca dentro um atributo
        // no main. tem que encapsular dentro do método como aqui. se ficar public não funciona.
    }
...
//		this.juro(); //nao posso acessar o juros depois de ver pois não vai exibir atualizado em tela
    ...
    // alteração apenas no método de juros que está sendo acessado
    // não pode ser public. boa prática, só tem utilidade aqui e não geral
    /*
     * private void juro() { this.saldo -= 1; }
     */
