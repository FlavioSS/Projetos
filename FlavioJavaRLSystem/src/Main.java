...
public class Main {
	...
	public static void main (String args[]) {
		...
		*/
		...
		////no java não existe String, e sim a classe String. Assim como Integer. (Letra maiúscula) double, int e char são tipos primitivos.
		String nome = "Flávio";
		...
		///Posteriormente posso criar um for a partir de um arrray declarado e exibido. O for é um laço de repetição. loop
		...
		///o length conta 0 + 4
		for(int i =0; i < paises.length; i++){//<= paises.length; i++){//3; i++){
			//System.out.println(paises[i]); //comentado para testar o outro for
		}
		
		///como um for each. Varrer um array. declara o tipo do array que vai ler, nome  : o array que vai ler. Vai declarar cada pais à variável pais;
